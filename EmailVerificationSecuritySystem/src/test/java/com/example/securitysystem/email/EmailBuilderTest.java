...
class EmailBuilderTest {
  ...
  void testBuildEmail() {
    ...
    String link = "https://example.com/activation-link";

    String expectedEmailContent = "<div style=\"font-family:Helvetica,Arial,sans-serif;"
        + "    font-size:16px;margin:0;color:#0b0c0c\">\n"
        + "\n"
        + "<span style=\"display:none;font-size:1px;color:#fff;max-height:0\"></span>\n"
        + "\n"
        + "  <table role=\"presentation\" width=\"100%\" style=\"border-collapse:collapse;"
        + "   min-width:100%;width:100%!important\" cellpadding=\"0\" "
        ...
        + "       font-size:19px;line-height:1.315789474;"
        + "       max-width:560px\">\n"
        + "        \n"
        + "            <p style=\"Margin:0 0 20px 0;"
        + "             font-size:19px;line-height:25px;color:#0b0c0c\">Hi " + name + ",</p>"
    ...
    String emailContent = emailBuilder.build(name, link);
